...
class FlashCert:
    ...
    def flash_certificate(self, use_esptool, selected_port, selected_baud, serialnumber_label, serialnumber, certID_label, uuid, macAddr_label, macAddr, securecert_addr, dataprovider_addr):
        ...
        cert_dir = '/home/anuarrozman2303/Airdroitech/FactoryApp_Merge/FlashingTool/certs/' + str(serialnumber) + '/espsecurecert/out/146d_1/' + str(uuid)
    ...
    def get_remaining_cert_ids(self, cert_ids):
        cert_dir = '/home/anuarrozman2303/Airdroitech/FactoryApp_Merge/FlashingTool/certs'
    ...
    def get_certId(self):
        try:
            with open('/home/anuarrozman2303/Airdroitech/FactoryApp_Merge/FlashingTool/device_data.txt', 'r') as file:
    ...
    def get_bin_path(self, certId):
        for root, dirs, files in os.walk("/home/anuarrozman2303/Airdroitech/FactoryApp_Merge/FlashingTool/certs"):
